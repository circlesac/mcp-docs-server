...
See the [Commands Overview](docs/commands/index.md) for a comparison and detailed guides. For configuration options, see the [Configuration Reference](docs/configuration.md). Learn how to create [reusable prompt templates](docs/prompts.md) for common workflows. Expose [any file type as browsable resources](docs/resources.md). Full documentation: [docs/index.md](docs/index.md).
