...
- Overview of the CLI and how the config works.
- Guidance on serving your own documentation.
- Steps for packaging and publishing docs to npm.

Use the MCP client of your choice to query this server. Paths available here mirror the structure inside the `docs/` directory.

## Quick Reference

- `overview/getting-started.md` – explains how to use the CLI locally.
